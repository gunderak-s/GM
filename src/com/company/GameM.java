...
public class GameM implements Serializable {
    ...
    public void setField() {
        ...
        fieldGame[0][4] = new CityCell("Барі", 2, RED_BACKGROUND, 0, 150, 150, null, fieldGame[1][4], 240, 20, 100, 300, 750, 925, 1100);
        fieldGame[0][6] = new CityCell("Амст", 2, PURPLE_BACKGROUND, 0, 150, 150, null, fieldGame[1][6], 260, 22, 110, 330, 800, 975, 1150);
        fieldGame[0][7] = new CityCell("Горн", 2, PURPLE_BACKGROUND, 0, 150, 150, null, fieldGame[1][7], 260, 22, 110, 330, 800, 975, 1150);
        fieldGame[0][9] = new CityCell("Лісе", 2, PURPLE_BACKGROUND, 0, 150, 150, null, fieldGame[1][9], 280, 24, 120, 360, 850, 1025, 1200);
        fieldGame[1][10] = new CityCell("Кріс", 3, BLUE_BACKGROUND, 0, 200, 200, null, fieldGame[1][9], 300, 26, 130, 390, 900, 1100, 1275);
        fieldGame[2][10] = new CityCell("Шієн", 3, BLUE_BACKGROUND, 0, 200, 200, null, fieldGame[2][9], 300, 26, 130, 390, 900, 1100, 1275);
        fieldGame[4][10] = new CityCell("Осло", 3, BLUE_BACKGROUND, 0, 200, 200, null, fieldGame[4][9], 320, 28, 150, 450, 1000, 1200, 1400);
        fieldGame[7][10] = new CityCell("Льві", 3, GRAY_BACKGROUND, 0, 200, 200, null, fieldGame[7][9], 350, 35, 175, 500, 1100, 1300, 1500);
        fieldGame[9][10] = new CityCell("Київ", 3, GRAY_BACKGROUND, 0, 200, 200, null, fieldGame[9][9], 400, 50, 200, 600, 1400, 1700, 2000);
        fieldGame[1][0] = new CityCell("Праг", 1, GREEN_BACKGROUND, 0, 100, 100, null, fieldGame[1][1], 200, 16, 80, 220, 600, 800, 1000);
        fieldGame[2][0] = new CityCell("Злін", 1, GREEN_BACKGROUND, 0, 100, 100, null, fieldGame[2][1], 180, 14, 70, 200, 550, 750, 950);
        fieldGame[4][0] = new CityCell("Брно", 1, GREEN_BACKGROUND, 0, 100, 100, null, fieldGame[4][1], 180, 14, 70, 200, 550, 750, 950);
        fieldGame[6][0] = new CityCell("Като", 1, BRIGHT_RED_BACKGROUND, 0, 100, 100, null, fieldGame[6][1], 160, 12, 60, 180, 500, 700, 900);
        fieldGame[7][0] = new CityCell("Опол", 1, BRIGHT_RED_BACKGROUND, 0, 100, 100, null, fieldGame[7][1], 140, 10, 50, 150, 450, 625, 750);
        fieldGame[9][0] = new CityCell("Вроц", 1, BRIGHT_RED_BACKGROUND, 0, 100, 100, null, fieldGame[9][1], 140, 10, 50, 150, 450, 625, 750);
        fieldGame[10][1] = new CityCell("Нант", 0, YELLOW_BACKGROUND, 0, 50, 50, null, fieldGame[9][1], 120, 8, 40, 100, 300, 450, 600);
        fieldGame[10][2] = new CityCell("Парж", 0, YELLOW_BACKGROUND, 0, 50, 50, null, fieldGame[9][2], 100, 6, 30, 90, 270, 400, 550);
        fieldGame[10][4] = new CityCell("Ліон", 0, YELLOW_BACKGROUND, 0, 50, 50, null, fieldGame[9][4], 100, 6, 30, 90, 270, 400, 550);
        fieldGame[10][7] = new CityCell("Манч", 0, CYAN_BACKGROUND, 0, 50, 50, null, fieldGame[9][7], 60, 4, 20, 60, 180, 320, 450);
